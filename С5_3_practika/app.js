...
btnNode.addEventListener('click', () => {
  let n = Number(inputNode.value);
  // console.log(inputNode.value);
  if (n >= 1 && n <= 10) {
    useRequest(`https://picsum.photos/v2/list/?limit=${n}`, displayResult);
  }
  else {
    resultNode.innerHTML = '<div class="result j-result">Число вне диапазона!</div>';
  }
});
